function params = PL_RC_params_TRAINING
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trial = struct('numTrialsInBlock', {120}, 'numTrialsPerLevel', {60});
...
stair = struct('run', {1}, 'numTrialsPerStaircase', {trial.numTrialsInBlock}, 'numStaircases', {2},...
                   'startOri', {startOriDiff}, 'maxThresh', {30}, 'minThresh', {log10(.1)},...
                   'startStepsize', {5},'minStepsize', {.001});
...
%      Save Data params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save = struct('fileName', {'PL_RC_training'}, 'expTypeDirName', {'results'}, 'SubjectInitials', {initials});
