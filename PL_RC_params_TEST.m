function params = PL_RC_params_TEST
...
stim = struct('sizeDeg', {[3 3]}, 'dur', {.06},...
              'possibleOri', {[tOri,tOri,uOri_InterCardinalOPTIONS]}, 'num', {1},...
...
%      Save Data params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save = struct('fileName', {'PL_RC_test'}, 'expTypeDirName', {'results'}, 'SubjectInitials', {initials});
