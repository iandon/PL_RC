...
Screen('DrawText', wPtr, blockMsg, params.screen.centerPix(1)-270, params.screen.centerPix(2)-200,[0 0 0]);
Screen('DrawText', wPtr, accuracyMsg, params.screen.centerPix(1)-270, params.screen.centerPix(2)-50,[0 0 0]);
Screen('DrawText', wPtr, pressSpace, params.screen.centerPix(1)-270, params.screen.centerPix(2)+150,[0 0 0]);
Screen('Flip', wPtr);
