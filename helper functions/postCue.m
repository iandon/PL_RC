...
x1 = params.screen.centerPix(1) - cosd(oriPossible)*fixRadiusPix(1);
x2 = params.screen.centerPix(1) + cosd(oriPossible)*fixRadiusPix(1);

y1 = params.screen.centerPix(2) - sind(oriPossible)*fixRadiusPix(2);
y2 = params.screen.centerPix(2) + sind(oriPossible)*fixRadiusPix(2);
