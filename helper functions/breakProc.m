function [trialProcNEW, recal, breakRecentNEW, breakTrackNEW] = breakProc(trialProc, nTrials, currTrialNum, currRunNum, breakFixStruct)%numFixBreaks, breakTrack, breakRecent)
...
%       breakFixStruct  :  structue with info on fixation break history,
%                          including:
%                               count=>  numFixBreaks  :  number of fixation breaks
%                               track=>  breakTrack    :  vector of runs on which there was a fixation break on this block, as of the previous fixation break
%                               recent=> breakRecent   :  number of recent fixation breaks, as of the previous fixation break ('recent' is not a straight-forward definition -> see breakProc.m file for details)
%
%   Outputs:
...
numFixBreaks = breakFixStruct.Block.count;
breakTrack   = breakFixStruct.Block.track;
breakRecent  = breakFixStruct.Block.recent;
