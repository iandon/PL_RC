function [trialProc] = calcTrialsVars_TEST(blockNum)
global params;
...
trialProc = cell(n,1);
for i = 1:n
   trialProc{i}.ori = params.stim.possibleOri(blockNum,oriNum(ord(i)));
   ...
   trialProc{i}.stimStruct = makeStimulusStruct(params.screen, params.stim, params.noise, trialProc{i}.ori, trialProc{i}.presAbs);
end
